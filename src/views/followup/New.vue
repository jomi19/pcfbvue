<template>
    ...
    <form class="main-content" v-on:submit="submitHandler">
        ...
        <input type="number" id="crossMessure" class="last-three" v-model="followUp.crossMessure"  required>
...
// @ is an alias to /src
    ...
    methods: {
        submitHandler: function(event) {
            ...
            axios.post(`${API_URL}followup/`, this.followUp)
                .then(() => {
